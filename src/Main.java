...
public class Main {
    ...
    public static final String NOT_EXIST = "Phone number does not exist.";
    ...
    private static void givenContact(Scanner in, ContactBook cBook){
        int phone;
        phone = in.nextInt(); in.nextLine();
    ...
    private static void sameContacts(ContactBook cBook) {
